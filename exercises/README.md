...
| 15. [AI-fabric capacity and failure model](15-ai-fabric-capacity-and-failure-model.md) | Compare deterministic baseline, rail, storage, and rollback evidence | Accelerator fabrics, capacity, congestion, ownership, interview design |
