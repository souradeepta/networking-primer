...
1. **Does BGP choose the geographically nearest site?** **Answer:** No. It chooses a
...
2. **How is GTM/DNS steering different from anycast?** **Answer:** DNS returns an answer
...
3. **Can an F5 monitor withdraw a BGP route automatically?** **Answer:** It can be part of
...
4. **Why can a route be visible but traffic still fail?** **Answer:** The forwarding next
...
5. **What is a more-specific route?** **Answer:** A longer prefix that wins longest-prefix
...
6. **What is route flapping?** **Answer:** Repeated announcements and withdrawals that
...
7. **Why are communities dangerous to assume?** **Answer:** Their semantics are local to
...
8. **What should an SDE own?** **Answer:** The application-side health contract, evidence,
