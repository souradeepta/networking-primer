...
1. **Does an up monitor guarantee a working service?** **Answer:** No; it proves only the
...
2. **Why can a healthy member receive no traffic?** **Answer:** Persistence, priority,
...
3. **What is a receive string?** **Answer:** A match condition in a monitor response, such
...
4. **Why is source persistence risky behind NAT?** **Answer:** Many clients can share one
...
5. **How should a monitor endpoint be designed?** **Answer:** Make it cheap, authenticated
...
6. **What evidence distinguishes a monitor failure?** **Answer:** Probe status/reason,
...
7. **Why retain pre-change state?** **Answer:** It makes review, comparison, and rollback
