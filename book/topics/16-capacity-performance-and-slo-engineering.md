...
1. **What does Little’s Law tell us?** **Answer:** It estimates average in-flight work as
...
2. **Why is CPU below 70% not an SLO?** **Answer:** Users care about successful and timely
...
3. **Can adding pool members solve all capacity problems?** **Answer:** No. DNS, F5,
...
4. **Why separate request rate and connection rate?** **Answer:** Keep-alive and HTTP/2
   multiplexing make them materially different loads. Connection setup and request counters therefore require separate saturation and latency evidence.
...
5. **How does GTM affect capacity planning?** **Answer:** It chooses answers and sites,
...
6. **Why can retries cause an outage?** **Answer:** Slower responses cause clients or
...
7. **What should a capacity automation report include?** **Answer:** Units, timestamp,
   source, aggregation, assumptions, saturation indicators, and confidence. These fields make the result reproducible and distinguish measured limits from modeled estimates.
...
8. **How do certificates affect capacity?** **Answer:** Handshakes, chain size, renewal,
