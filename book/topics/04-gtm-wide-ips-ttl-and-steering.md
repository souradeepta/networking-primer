...
1. **Does Wide IP answer every DNS query?** **Answer:** It is a logical application object;
...
2. **Does a low TTL force immediate failover?** **Answer:** No; caches and clients may keep
...
3. **What does a monitor prove?** **Answer:** Only the configured probe’s view of one
...
4. **Why query authority and resolver separately?** **Answer:** The authority shows current
...
5. **What is fallback?** **Answer:** The rule used when preferred pools or targets cannot
...
6. **Why can users in two regions differ?** **Answer:** Their recursive resolvers, cached
...
7. **What is a safe incident artifact?** **Answer:** Timestamped `dig` output, policy
