...
1. **Does DNS prove an address is in use?** **Answer:** No; it proves an authoritative
...
2. **What proves a DHCP lease?** **Answer:** The authoritative DHCP server’s lease record
...
3. **Why not auto-delete stale records?** **Answer:** The apparent staleness may be a
...
4. **What is IPAM’s role?** **Answer:** It records allocation, ownership, purpose, and
...
5. **How detect duplicates?** **Answer:** Correlate authoritative records with controlled
...
6. **Why include TTL in drift work?** **Answer:** A corrected authority may remain hidden
...
7. **What makes reconciliation safe?** **Answer:** Read-only report, explicit authority,
