...
1. **What makes chaos safe?** **Answer:** A bounded target, hypothesis, expected result,
...
2. **Why test monitor and user paths separately?** **Answer:** They may use different
...
3. **Does DNS failover instantly move all users?** **Answer:** No. Resolver and client
...
4. **Why test fresh and persistent connections?** **Answer:** Load balancers and proxies
...
5. **What should a F5 SDK integration test assert?** **Answer:** The desired object graph,
...
6. **Is `tc netem` safe anywhere?** **Answer:** No. It changes the selected interface and
...
7. **Why use a test CA for mTLS?** **Answer:** It isolates trust and prevents a lab client
...
8. **What is a useful chaos output?** **Answer:** A measured comparison of expected and
